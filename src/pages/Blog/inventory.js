      ...
      <Box px={'78px'}>
        ...
        <Box w={'75%'} ml='auto' mt='58px' pb='70px'>
          ...
          <Box ref={benefitRef} id='benefit'>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>1. Precise Allocation </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>2. Optimized Pricing Strategies </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>3. Customized Offerings </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>4. Accurate Sales Forecasting</Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>5. Customer Satisfaction</Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>6.Project Performance Evaluation</Text>
              <Text>
