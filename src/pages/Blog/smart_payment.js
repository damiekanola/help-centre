      ...
      <Box px={'78px'}>
        ...
        <Box w={'75%'} ml='auto' mt='58px' pb='70px' fontFamily='euclid-light' fontSize='16px'>
          <Box>
            ...
            <Text mt='30px'>
              Acknowledging this shortfall, we were fortunate to have an alpha-phase feature that could address this issue. This innovative feature became our secret weapon for accelerating cash flow into the company. We understand that time can be both a buyer’s best friend and worst enemy when it comes to payments. When buyers choose to pay early, time works in their favor, providing a sense of accomplishment and potentially reducing their outstanding balances.
            </Text>
            <Text mt='30px'>
