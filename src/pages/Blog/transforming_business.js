      ...
      <Box px={'78px'}>
        ...
        <Box w={'75%'} ml='auto' mt='58px' pb='70px'>
          ...
          <Box ref={perksRef} id='perks'>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>1. Elevates the Customer Experience </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>2. Amplifies Team Productivity </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>3. Expedites Issue Resolution </Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>4. Cost Reduction and Heightened Customer Retention</Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>5. Enhances Project Transparency and Collaboration</Text>
              <Text>
            ...
            <Box mt='30px'>
              <Text fontWeight={600} fontSize={'20px'} color='#000'>6. Efficient Resource Allocation and Workload Management</Text>
              <Text>
