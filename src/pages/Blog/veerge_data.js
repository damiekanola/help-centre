          ...
          <Box mt='20px' ref={why_veergeRef} id='why_veerge'>
            ...
            <Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What are customers saying about properties and services?
                  </ListItem>
                  <ListItem>
                    Are there common issues or complaints?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How often do customers interact with the application?
                  </ListItem>
                  <ListItem>
                    Which features are most frequently used by customers?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What types of properties are in highest demand?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Where do potential customers drop off in the sales process?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What are the main reasons for customer attrition?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How are sales teams performing in different regions?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How do property prices vary across different locations?
                  </ListItem>
                  <ListItem>
                    Are there any pricing trends based on property features?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How does it vary for different customer segments?
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How many customers were acquired through referrals?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What is the overall demand for properties in the market?
                  </ListItem>
                  <ListItem>
                    Are there any seasonal fluctuations in demand?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How quickly are properties being sold once listed?
                  </ListItem>
                  <ListItem>
                    Which properties have the longest holding periods?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What aspects of the application need improvement?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How many issues are resolved on the first contact?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How many properties pass inspection without issues?
                  </ListItem>
                  <ListItem>
                    What are the common issues found during inspections?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How do their behaviours and preferences differ?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How much revenue is generated per marketing dollar spent?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How do property values change over time?
                  </ListItem>
                  <ListItem>
                    Which locations experience the highest appreciation rates?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What are the most cost-effective user acquisition channels?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How responsive is the application under different user loads?
                  </ListItem>
                  <ListItem>
                    Are there any bottlenecks affecting performance?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How effective are loyalty programs in retaining customers?
                  </ListItem>
                  <ListItem>
                    What rewards or incentives drive the most loyalty?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What are the emerging trends in the property market?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Which customer segments respond best to personalized offers?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What improvements can be made to enhance user satisfaction?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How long have properties been in the inventory before sale?
                  </ListItem>
                  <ListItem>
                    Are there any patterns related to unsold inventory?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can the company optimize its sales distribution channels?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Are there any bottlenecks in the conversion process?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Which acquisition sources bring the most valuable customers?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Are there any patterns related to payment delays?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What is the return on investment for different properties?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How often do customers request refunds, and for what reasons?
                  </ListItem>
                  <ListItem>
                    Are there any specific pain points in the customer experience that lead to refunds?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How many customers return for repeat transactions?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How many leads does each salesperson convert on average?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    Where do referred customers primarily come from?
                  </ListItem>
                  <ListItem>
                    Which referral sources are the most effective?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How often do customers make property purchases?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What is the sentiment of online discussions and reviews about the company's properties?
                  </ListItem>
                  <ListItem>
                    How can sentiment analysis inform marketing strategies?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What is the average rental income per property?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can location data inform future development decisions?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can this data be used for personalized recommendations?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What sizes of properties are most popular among buyers?
                  </ListItem>
                  <ListItem>
                    Are there trends in property size preferences?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Is there demand for additional payment options?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Are there ways to streamline the onboarding process?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What are the major cost components of property development?
                  </ListItem>
                  <ListItem>
                    Where can cost savings be realized?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can regional strategies be adjusted accordingly?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can marketing campaigns align with these changes?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What is the average age of properties in the inventory?
                  </ListItem>
                  <ListItem>
                    How does property age affect pricing and demand?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How diversified is the property portfolio in terms of property types and locations?
                  </ListItem>
                  <ListItem>
                    Are there gaps or over-concentration in the portfolio?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Does education impact conversion rates?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What motivates customers to resell properties?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How many users access the platform through mobile apps?
                  </ListItem>
                  <ListItem>
                    What features are most used on mobile?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What amenities in properties are most attractive to buyers?
                  </ListItem>
                  <ListItem>
                    How can amenities be enhanced to boost sales?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    Which communication channels have the highest response rates?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    Do customers have specific preferences for property features (e.g., swimming pools, gardens)?
                  </ListItem>
                  <ListItem>
                    How can these preferences be catered to?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    Can data predict when a property will require maintenance?
                  </ListItem>
                  <ListItem>
                    How can predictive maintenance reduce costs and downtime?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    How many customers express intent to purchase a property?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    Why do customers choose not to complete a purchase?
                  </ListItem>
                  <ListItem>
                    Are there opportunities to address their concerns?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How does it compare to the total investment?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    What external factors (e.g., economic conditions, political stability) pose risks to the business?
                  </ListItem>
                  <ListItem>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What is the default rate on financed properties?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can the company tailor offerings to these niches?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    What strategies are most effective in building trust?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  ...
                  <ListItem>
                    How can loyalty-building efforts be focused effectively?
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box mt='20px'>
                ...
                <UnorderedList pl='10px'>
                  <ListItem>
                    Can data models predict future sales trends and patterns?
                  </ListItem>
                  <ListItem>
                    How can these predictions inform strategic decisions?
                  </ListItem>
                </UnorderedList>
              </Box>
