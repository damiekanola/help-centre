      ...
      <Box px={'78px'}>
        ...
        <Box w={'75%'} ml="auto" mt="58px" pb="70px" fontWeight={200} fontSize="16px">
          <Box ref={overviewRef} id="overview">
            <Text>
            Let's be frank – revenue is the lifeblood of any business's success. Without it, any organization simply cannot thrive. While generating profits can be an arduous task, monitoring and managing those earnings can present an even greater challenge. Grasping your income and comprehending your financial standing demands effort and a firm grasp of a fundamental accounting principle: revenue recognition. 
            </Text>
            <Text mt={'30px'}>
