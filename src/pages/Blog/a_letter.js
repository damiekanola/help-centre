      ...
      <Box px={'78px'}>
        <Box w={'75%'} ml='auto' mt='58px' pb='70px' fontWeight={200} fontSize='16px'>
          <Box>
            ...
            <Text mt='20px'>
            However, in the technology industry, where revolutionary ideas drive significant growth, it is crucial to embrace discomfort in order to stay relevant. While our company is currently performing well, we believe we can make it even more transparent, ethical, and accountable.
            </Text>
            <Text mt='20px'>
            ...
            <Text mt='20px' fontWeight={500} fontSize={'20px'} color='#000'>-Ahmed Ibraheem</Text>
          </Box>
          <Helpful white />
        </Box>
      </Box>
