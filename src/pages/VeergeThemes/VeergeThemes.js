    ...
    <div className="main">
      ...
      <Text className="content" lineHeight={'25px'} mt='50px'>
        <Box mb='30px' id="veerge_theme" ref={veerge_themeRef}>
          ...
          <Text mt='30px' as='p' fontWeight={400}>
            When developing an application on Veerge, you have the option to choose from both the free and paid themes. It's often recommended to schedule a meeting with Veerge support to discuss your business needs, thoughtful design decisions, user experience considerations, and specific application requirements and goals.
          </Text>
          <Text mt='30px' as='p' fontWeight={400}>
            Please keep in mind that the availability of ongoing updates and support for themes on Veerge may vary depending on your subscription tier. Typically, <b>Tier 2</b> and <b>Tier 3</b> subscriptions offer continued updates for themes, including new mobile features and support. However, <b>Tier 1</b> may have limited access to free updates and support.
          </Text>
          <Text mt='30px' as='p' fontWeight={400}>
