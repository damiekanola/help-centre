      ...
      <Box className="content" lineHeight={'25px'}>
        ...
        <Box id="commission" ref={commissionRef}>
          ...
          <Text as='p'>
            ...
            specifically within the "Commission Request" category. You, as the administrator, are presented with the option to either approve or reject the commission request.
          </Text>
        </Box>
        <Box id="approving" ref={approvingRef}>
          <Text as='p' marginTop="20px" fontSize={'24px'}  letterSpacing={'2.88px;'}>Step-by-Step Guide to Approving Commissions</Text>
          <Box>
            <Text as='p' marginTop="20px" fontSize={'24px'} fontWeight={500}>STEP 1</Text>
            <Text as='p' marginTop="20px">
          ...
          <Box>
            <Text as='p' marginTop="20px" fontSize={'24px'} fontWeight={500}>STEP 2</Text>
            <Text as='p' marginTop="20px">
          ...
          <Box>
            <Text as='p' marginTop="20px" fontSize={'24px'} fontWeight={500}>STEP 3</Text>
            <Text as='p' marginTop="20px">
          ...
          <Box>
            <Text as='p' marginTop="20px" fontSize={'24px'} fontWeight={500}>STEP 4</Text>
            <Text as='p' marginTop="20px">
          ...
          <Box>
            <Text as='p' marginTop="20px" fontSize={'24px'} fontWeight={500}>STEP 5</Text>
            <Text as='p' marginTop="20px">
