...
export const Listings = () => {
  ...
  const articleContent = [
    { id: 'overview', title: 'Overview of listings' },
    { id: 'listings', title: 'Listings & Units' },
    { id: 'payment', title: 'Payment plan' },
    { id: 'allocations', title: 'Allocations' },
    { id: 'archive', title: 'Archive a unit' },
