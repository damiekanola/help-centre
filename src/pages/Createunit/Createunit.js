...
import createUnit1 from '../../assets/images/create-unit-1.png';
import createUnit2 from '../../assets/images/create-unit-2.png';
import createUnit3 from '../../assets/images/create-unit-3.png';
import createUnit4 from '../../assets/images/create-unit-4.png';
import createUnit5 from '../../assets/images/create-unit-5.png';
import createUnit6 from '../../assets/images/create-unit-6.png';
import createUnit7 from '../../assets/images/create-unit-7.png';
import createUnit8 from '../../assets/images/create-unit-8.png';
...
export const Createunit = () => {
  ...
  const articleContent = [
    { id: 'how_to', title: 'How to create unit  allocation' },
  ...
  return (
    <div className="main" id="how_to">
      ...
      <Box>
        <Text className="content" lineHeight={'25px'}>
          ...
          <Text as='p' marginTop="20px">
            Allocations play a vital role in ensuring precise unit assignment to the appropriate individuals, guided by factors like agreements, contracts, preferences, or prior purchases. This procedure holds particular significance in projects involving multiple units, such as apartment complexes or housing estates, where each unit boasts unique features, sizes, and values.
          </Text>
          <Text as='p' marginTop="20px">
            Let's delve into the example of Barrio Logan to understand how allocation milestones are handled:
            Assuming Barrio Logan's allocation milestone is set at 70%, here are the steps to navigate this process:
          </Text>
        </Text>
      </Box>
      <Box>
        ...
        <Text className="content">
          Begin by choosing the listing and the specific unit you wish to allocate. For instance, let's take the example of the 1 bedroom flat.
        </Text>
      ...
      <Box>
        ...
        <Text className="content">
          Select the appropriate milestone that corresponds with the allocation process. This milestone defines the stage at which allocation becomes available, often linked to project progress. In this case we will choose 70% (i.e once subscribers have made 70% of payment they are eligible for allocation.
        </Text>
      ...
      <Box>
        ...
        <Text className="content">
          Provide images that offer a comprehensive breakdown of the building's layout or structure (You can upload up to 5 images).
        </Text>
      ...
      <Box>
        ...
        <Text className="content" lineHeight={'25px'}>
          <Text as='p' marginTop="20px">
            Remember, these steps apply to every other unit you intend to allocate—except for the penthouse. Since the penthouse is a single unit with no allocation divisions, you won't need to perform the allocation setup for it.
          </Text>
          <Text as='p' marginTop="20px">
