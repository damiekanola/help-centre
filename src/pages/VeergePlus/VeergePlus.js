      ...
      <Text className="content" lineHeight={"25px"} mt="20px">
        <Box mb="30px" id="personalize" ref={personalizeRef}>
          ...
          <Text mt="20px" as="p" fontWeight={400}>
            Veerge Plus is the ultimate real estate cloud-based infrastructure
            designed to help you reach more potential buyers, and meet more of
            your business needs
          </Text>
        </Box>
        <Box mb="30px" id="committed" ref={committedRef}>
          ...
          <Text as="p" fontWeight={400}>
            ...
            <UnorderedList>
              <ListItem>
                Enjoy 24/7 priority technical support via phone, email, or live
                chat. Our dedicated support team is always ready to assist you.
              </ListItem>
              <ListItem>
                Gain valuable platform knowledge and industry insights while
                also staying updated with the latest trends and strategies.
              </ListItem>
              <ListItem>
                Experience personalized migration, launch, and account
                management support at no extra cost. We'll guide you every step
                of the way.
              </ListItem>
              <ListItem>
                Customize your platform further with over 100 certified apps and
                tailor Veerge Plus to suit your specific business requirements.
              </ListItem>
            </UnorderedList>
          </Text>
        </Box>
          ...
          <Text as="p" fontWeight={400}>
            ...
            <OrderedList spacing={30}>
              <ListItem mt={"30px"}>
                ...
                management system. The Veerge Portal serves as the
                infrastructure to balance day-to-day business activities with
              ...
              <ListItem>
                ...
                provides a personalized experience tailored to each buyer's
              ...
              <ListItem>
                ...
                until purchases are made, here, access to funds is immediate
                upon wallet funding.
              </ListItem>
            </OrderedList>
          </Text>
        ...
        <Box mb="50px" id="pricing" ref={pricingRef}>
          ...
          <Text as="p" fontWeight={400}>
            Veerge offers various pricing options to cater to different business
          ...
          <OrderedList listStyleType={"decimal"} mt="30px">
            <ListItem fontWeight={600}>
              ...
              <Text fontWeight={200}>
                ...
                will be $600 per month for a year.
              </Text>
            </ListItem>
            <Link to="/">
            ...
            <ListItem fontWeight={600}>
              ...
              <UnorderedList fontWeight={200} pl="10px">
                ...
                <ListItem>
                  ...
                  of premium features and top-notch performance, begins at{" "}
                  <b>$1500</b>.
                </ListItem>
              </UnorderedList>
            </ListItem>
          ...
          <Text mt="30px">
            If you're uncertain about which pricing plan to choose, you can
            schedule a meeting with Veerge support. They will assist you in
            transforming your business and finding the perfect plan. Remember,
            you can always upgrade your plan when needed.
          </Text>
        </Box>
        <Box mb="30px" id="getting" ref={gettingRef}>
            ...
            <OrderedList spacing={30}>
              <ListItem fontWeight={600} mt="30px">
                ...
                <Text fontWeight={200}>
                  ...
                  and register for a free trial. This will grant you access to
                  the platform, enabling you to test the application, make
                  design decisions, and explore its features. It's an
                  opportunity to familiarize yourself with Veerge before
              ...
              <ListItem fontWeight={600}>
                ...
                <Text fontWeight={200}>
                  ...
                  subscription. Pick the plan that suits your needs and fits
              ...
              <ListItem fontWeight={600}>
                ...
                <Text fontWeight={200}>
                  ...
                  users. These links enable you to experience Veerge on your
                  preferred device, ensuring a smooth and tailored user
                  experience.
                </Text>
              </ListItem>
              <ListItem fontWeight={600}>
                ...
                <Text fontWeight={200}>
                  ...
                  allows you to shape and fine-tune your real estate
                  infrastructure. Rest assured that there are no subscription
                  fees during this phase, providing you with an opportunity to
              ...
              <ListItem fontWeight={600}>
                ...
                <Text fontWeight={200}>
                  ...
                  have an appealing and functional design, enhancing the overall
                  user experience.
                </Text>
              </ListItem>
              <ListItem fontWeight={600}>
          ...
          <Text mt="30px">
            Throughout your transformation journey, Veerge is committed to
            supporting you. Enjoy the seamless experience, personalized
            features, and exceptional support provided by Veerge as you embark
            on this new chapter.
          </Text>
        </Box>
      </Text>
