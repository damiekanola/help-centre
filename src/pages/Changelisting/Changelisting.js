...
import changeListing1 from '../../assets/images/change-listing-1.png';
import changeListing2 from '../../assets/images/change-listing-2.png';
import changeListing3 from '../../assets/images/change-listing-3.png';
import changeListing4 from '../../assets/images/change-listing-4.png';
import modifyUnit1 from '../../assets/images/modify-unit-1.png';
import modifyUnit2 from '../../assets/images/modify-unit-2.png';
import modifyUnit3 from '../../assets/images/modify-unit-3.png';
import modifyUnit4 from '../../assets/images/modify-unit-4.png';
import modifyUnit5 from '../../assets/images/modify-unit-5.png';
import modifyUnit6 from '../../assets/images/modify-unit-6.png';
import editPaymentPlan1 from '../../assets/images/edit-payment-plan-1.png';
import editPaymentPlan2 from '../../assets/images/edit-payment-plan-2.png';
import editPaymentPlan3 from '../../assets/images/edit-payment-plan-3.png';
import editPaymentPlan4 from '../../assets/images/edit-payment-plan-4.png';
import editPaymentPlan5 from '../../assets/images/edit-payment-plan-5.png';
...
export const Changelisting = () => {
  ...
  const articleContent = [
    { id: 'how_to', title: 'How to change a listing information ' },
  ...
  const questions = [
    {
      name: 'Ahmed A.',
      date: 'Jun 25, 2023',
      content: "Prior to editing, the price was showing on the application, but now it no longer shows.",
      replies: [
  ...
  return (
    <div className="main" id="how_to">
      ...
      <Box>
        ...
        <Text className="content" mt='20px'>
          Within this interface, you have the freedom to adjust various fundamental aspects of the listing. These include essentials like the listing's name, location, projected delivery date, project brochure, listed amenities, images, and description.
        </Text>
      ...
      <Box>
        ...
        <Text className="content" mt='20px'>
          <Text as='p'>
            By following these steps, you can easily tailor your listing's information to match any adjustments or developments related to your project. Your listing will reflect the latest and most accurate information, ensuring that potential clients receive the current details they need.
          </Text>
        </Text>
      ...
      <Box>
        ...
        <Text className="content" mt='20px'>
          Remember, meticulous attention to detail during the modification process is vital, especially when altering unit quantities or prices. This way, you can ensure that your listing reflects the most current and accurate information, aligning with your project's evolving dynamics.
        </Text>
      ...
      <Box>
        ...
        <Text className="content" mt='20px'>
          By following these steps, you can effectively edit payment plans associated with your units. Remember that while you can't delete a payment plan, making it private and creating a new one provides you with the flexibility to adjust payment structures according to your requirements.
        </Text>
